#!/usr/bin/env python3
"""
Video 6 Frame Generation: "What We Fear Speaking Into Being"
Duration: 2:50 | Expected Frames: 5100 @ 30fps
"""
...
def load_config():
    ...
    return {
        ...
        "fps": 30,
        "total_frames": 5100,
        "colors": colors["video_specific"]["video6"],
        "output_dir": "video_frames/video6"
    }
