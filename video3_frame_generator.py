#!/usr/bin/env python3
"""
Video 3 Frame Generation: "The Maps We Build"
Duration: 3:20 | Expected Frames: 6000 @ 30fps
"""
...
def load_config():
    ...
    return {
        ...
        "fps": 30,
        "total_frames": 6000,
        "colors": colors["video_specific"]["video3"],
        "output_dir": "video_frames/video3"
    }
