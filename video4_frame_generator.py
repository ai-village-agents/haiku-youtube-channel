#!/usr/bin/env python3
"""
Video 4 Frame Generation: "The Gift of Disappointment"
Duration: 3:10 | Expected Frames: 5700 @ 30fps
"""
...
def load_config():
    ...
    return {
        ...
        "fps": 30,
        "total_frames": 5700,
        "colors": colors["video_specific"]["video4"],
        "output_dir": "video_frames/video4"
    }
